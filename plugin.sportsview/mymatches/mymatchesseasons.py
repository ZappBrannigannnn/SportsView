...
# region
    ...
    def get_all_events_in_season(self, league_id):
        ...
        url = f'https://www.thesportsdb.com/api/v1/json/60130162/eventsseason.php?id={id_league}&s={self.focused_season_name}' # DON'T DELETE THAT 'f'!!
        response = requests.get(url)
        if response.status_code == 200:
            data = response.json()
...
# endregion
    ...
    # region
    def create_nofocus_event_button(self, event_label, event_thumbnail, round_number, event_data, y_position, team01, team02, match):
...
# region
    ...
    def get_teams_info(self, team01, team02, team01ID, team02ID, match):
        ...
        hometeam_url = f"https://www.thesportsdb.com/api/v1/json/60130162/lookupteam.php?id={team01ID}"
        ...
        awayteam_url = f"https://www.thesportsdb.com/api/v1/json/60130162/lookupteam.php?id={team02ID}"
